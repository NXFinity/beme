...
export class ThemePanelComponent implements AfterViewInit {
  @HostBinding('class.active') get hostClasses() {
    return this.active;
  }
  ...
  coverList = [
    ...
    {
      name: 'Cover 6',
      coverThumbImage: '/assets/img/cover/cover-thumb-6.jpg',
      coverClass: 'bg-cover-6',
    },
    {
      name: 'Cover 7',
      coverThumbImage: '/assets/img/cover/cover-thumb-7.jpg',
      coverClass: 'bg-cover-7',
    },
    {
      name: 'Cover 8',
      coverThumbImage: '/assets/img/cover/cover-thumb-8.jpg',
      coverClass: 'bg-cover-8',
    },
    {
      name: 'Cover 9',
      coverThumbImage: '/assets/img/cover/cover-thumb-9.jpg',
  ...
  constructor(
    ...
    private appVariablesService: VariablesService,
  ) {}
